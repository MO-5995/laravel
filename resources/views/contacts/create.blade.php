                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <select name="age">
                                                    ...
                                                    <option value="2" {{old('age') == 2 ? 'selected': ''}}>20〜29歳
                                                    </option>
                                                    <option value="3" {{old('age') == 3 ? 'selected': ''}}>30〜39歳
                                                    </option>
                                                    <option value="4" {{old('age') == 4 ? 'selected': ''}}>40〜49歳
                                                    </option>
                                                    <option value="5" {{old('age') == 5 ? 'selected': ''}}>50〜59歳
                                                    </option>
