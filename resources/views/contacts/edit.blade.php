                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <input type="radio" name="gender" value="0" @if($contact->gender ==
                                                0) checked @endif>男性
                                                <input type="radio" name="gender" value="1" @if($contact->gender ==
                                                1) checked @endif>女性
                                            </div>
                                        </div>
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <select name="age">
                                                    ...
                                                    <option value="1" @if($contact->age ==
                                                        1) selected @endif>〜19歳</option>
                                                    <option value="2" @if($contact->age ==
                                                        2) selected @endif>20〜29歳</option>
                                                    <option value="3" @if($contact->age ==
                                                        3) selected @endif>30〜39歳</option>
                                                    <option value="4" @if($contact->age ==
                                                        4) selected @endif>40〜49歳</option>
                                                    <option value="5" @if($contact->age ==
                                                        5) selected @endif>50〜59歳</option>
                                                    <option value="6" @if($contact->age ==
                                                        6) selected @endif>60歳〜</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                <label for="contact"
                                                    class="leading-7 text-sm text-gray-600">お問い合せ内容</label>
